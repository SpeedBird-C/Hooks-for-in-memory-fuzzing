...
#define TARGET_APP_NAME "explorer.exe"//"D - Target With Virtual Member Function.exe"
#define PAYLOAD_DLL_NAME "08B-DLL-Payload.dll"
#define PAYLOAD_FUNC_NAME "Mine_GetFastFileInformation"
...
int main(int argc, const char** argv)
{
	...
	HMODULE base = FindModuleInProcess(remoteProcessHandle,"windows.storage.dll");
	check(base);
